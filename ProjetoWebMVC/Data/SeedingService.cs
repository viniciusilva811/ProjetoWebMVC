...
namespace ProjetoWebMVC.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            {
                return; //se o banco ja foi populado, não deve retornar nada.
            }
            ...
            Seller s2 = new Seller(2, "Kyla", "kyla@gmail.com", new DateTime(1987, 4, 10), 800.0, d3);
            Seller s3 = new Seller(3, "Alex", "alex@gmail.com", new DateTime(1998, 4, 02), 800.0, d3);
            Seller s4 = new Seller(4, "Maria", "maria@gmail.com", new DateTime(2000, 8, 21), 4000.0, d2);
            Seller s5 = new Seller(5, "Joseph", "joseph@gmail.com", new DateTime(2002, 4, 15), 2000.0, d2);
            Seller s6 = new Seller(6, "Ferdinand", "ferdinand@gmail.com", new DateTime(1998, 4, 29), 700.0, d4);
            Seller s7 = new Seller(7, "Aila", "aila@gmail.com", new DateTime(2000, 4, 21), 1000.0, d3);
